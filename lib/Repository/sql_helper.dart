...
class SqlHelper {
  static const String tableFullName = 'docum.db';
  static const String tableName = 'docum';
...
CREATE TABLE $tableName ('id' INTEGER PRIMARY KEY AUTOINCREMENT,'to' TEXT NOT NULL,'from' TEXT NOT NULL,'description' TEXT NOT NULL,'attachNumber' INTEGER NOT NULL,'createdAt' DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP);
''');
    });
  }
